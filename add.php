<?php
if (!empty($_POST["add_record"])){ // le name bouton add
    require_once("db.php");
    $sql = "INSERT INTO poste (post_title,description,post_at)
            VALUES (:post_title, :description, :post_at)";
    $stmt = $cnx->prepare($sql);
    $result= $stmt->execute(array(  ':post_title'   => $_POST['post_title'], // les names des outils dans le formulaire
...
<html>
<head>
<title>PHP PDO CRUD - Add Record</title>
<style>
...
<div class="frm-add">
<h1 class="demo-form-heading">Ajouter un article</h1>
